...
| System Slayer | `scoreboard`, `server_form`, `hud` (implicit) |
...
|---|---|---|
| `hud_screen.json` | HUD, title, subtitle, actionbar, chat | Scoreboar, Bl4z3, WayMar, ChunkPrevi, Leaderboar, System Slayer |
...
| `chest_screen.json` | Containers (chest, ender, shulker, barrel) | invsee |
| `ui_template_buttons.json` | Vanilla buttons (`common_buttons`) | Bl4z3 |
...
| `trade_2_screen.json` | Villager trade | Bl4z3 (subpack) |
| `pause_screen.json` | Pause menu | WayMar, ChunkPrevi, yUyl6Pz Scoreboar, System Slayer |
