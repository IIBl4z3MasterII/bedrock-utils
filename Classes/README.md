...
Dynamic Pros Template ───────► DynamicStore/WorldManager, base reutilizable por todos
```
...
| 💾 **Dynamic Pros Template** | `worldManager.js`, `logger.js` | [Dynamic Pros Template/README.md](Dynamic%20Pros%20Template/README.md) |
