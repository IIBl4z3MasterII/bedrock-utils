...
function resolveMsg(msgOrErr) { return msgOrErr instanceof Error ? msgOrErr.message : String(msgOrErr); }
function resolveStack(msgOrErr) { return msgOrErr instanceof Error ? `\n${msgOrErr.stack}` : ""; }
