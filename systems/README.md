...
| [**mob-stacker**](mob-stacker/README.md) | Stack de mobs + sistema de misiones integrado | Import directo (autoregistra) |
...
```js
import { inicializarSistemaBaneos, worldManager, missionSystem } from "./systems/index.js";
