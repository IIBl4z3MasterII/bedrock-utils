...
|---|---|---|---|
| `giveItem(player, itemStack)` | `player: Player`, `itemStack: ItemStack` | `boolean` | Da el item; si no entra completo, dropea el sobrante al suelo. `true` si entró completo |
