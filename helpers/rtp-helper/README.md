...
|---|---|---|---|
| `rtp(player, targetDimension?)` | `player: Player`, `targetDimension?: Dimension` | `boolean` | Inicia el RTP. `false` si está en cooldown o ya hay un RTP en curso para ese jugador |
